...
const OTP_BORDER_COLOR = '#3B82F6';
const OTP_ACTIVE_BORDER_COLOR = '#1D4ED8';
      ...
      >
        ...
        <View style={styles.resendRow}>
          ...
          <Pressable onPress={handleResend} hitSlop={8} disabled={isResending}>
            {isResending ? (
              <ActivityIndicator size="small" color={OTP_BORDER_COLOR} />
            ) : (
...
const styles = StyleSheet.create({
  ...
  otpBoxActive: {
    borderColor: OTP_ACTIVE_BORDER_COLOR,
